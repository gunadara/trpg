    ...
    {#if docs.length === 0}
      ...
      <div class="flex-1 flex items-center justify-center px-4 py-6">
        ...
        >
          아직 등록된 종족 문서가 없습니다.
          <br />
          우측 상단의 <strong>“새 종족 문서”</strong> 버튼을 눌러 시작해보세요.
        </p>
      </div>
...
{/if}
      ...
      {:else}
        <div class="m-auto text-center text-sm text-slate-500 dark:text-slate-400 space-y-2">
          <p>왼쪽에서 종족 문서를 선택하거나,</p>
          <p>
            우측 상단의 <strong>“새 종족 문서”</strong> 버튼을 눌러 첫 문서를 만들어보세요.
          </p>
        </div>
      {/if}
    </section>
