...
<DocEditLayout
  icon={META.icon}
  title="퀘스트 편집"
  subtitle="퀘스트 목표, 단계, 보상, 연계 문서를 정리합니다."
  onBack={backToList}
      ...
      <div class="space-y-3">
        ...
        <div>
          ...
          <input
            ...
            placeholder="예: 안개 숲에서 파편 1개 회수 → 의뢰인에게 전달 (보상: 200G)"
          />
        </div>
      </div>
      ...
      <div class="flex-1 flex flex-col gap-2">
        ...
        <div class="relative flex-1">
          <textarea
            ...
            placeholder="목표/조건, 진행 단계, 실패 조건, 보상, 의뢰인/장소, 연계 퀘스트 등을 적어보세요."
          ></textarea>
