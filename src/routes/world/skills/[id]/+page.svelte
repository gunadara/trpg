...
<script lang="ts">
  ...
  const CATEGORY: CategoryId = 'skills';
...
<DocEditLayout
  icon={META.icon}
  title="스킬 편집"
  subtitle="효과, 비용, 쿨타임, 조건 등을 정리합니다."
  onBack={backToList}
      ...
      <div class="space-y-3">
        ...
        <div>
          ...
          <input
            ...
            placeholder="예: 전방 베기 1회 + 출혈(30%) / 비용 2 / 쿨 10초"
          />
        </div>
      </div>
      ...
      <div class="flex-1 flex flex-col gap-2">
        ...
        <div class="relative flex-1">
          <textarea
            ...
            placeholder="효과/계수, 비용(마나·기력), 쿨타임, 사거리, 시전 조건, 상호작용(상태이상/연계)을 적어보세요."
          ></textarea>
