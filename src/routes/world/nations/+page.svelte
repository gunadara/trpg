...
<section class="h-full flex flex-col">
  <header class="mb-4 flex items-center justify-between gap-3">
    ...
    <p class="text-sm text-slate-500 dark:text-slate-400">
      제국, 왕국, 도시 국가 등 세계의 정치 단위를 정리합니다.
    </p>
        ...
        <div class="space-y-3">
          ...
          <div>
            ...
            <input
              ...
              placeholder="예: 사계절 내내 눈이 내리는 산악 왕국"
            />
          </div>
        </div>
...
<div class="flex-1 flex flex-col gap-2">
  ...
  <div class="relative flex-1">
    <textarea
      ...
      placeholder="정치 체제, 지리, 주요 도시, 동맹/적대 관계 등을 적어보세요."
    ></textarea>
    ...
    {/if}
      ...
      {:else}
        <div class="m-auto text-center text-sm text-slate-500 dark:text-slate-400 space-y-2">
          <p>왼쪽에서 나라 문서를 선택하거나,</p>
          <p>
            우측 상단의 <strong>“새 나라 문서”</strong> 버튼을 눌러 첫 문서를 만들어보세요.
          </p>
        </div>
      {/if}
    </section>
