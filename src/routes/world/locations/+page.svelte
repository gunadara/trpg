<script lang="ts">
  ...
  import { currentWorldId } from '$lib/stores/worldStore';
   ...
   const CATEGORY: CategoryId = 'locations';
...
<section class="h-full flex flex-col">
  ...
  <div class="flex-1 flex items-center justify-center px-4 py-6">
    ...
    >
      아직 등록된 장소 문서가 없습니다.
      <br />
      우측 상단의 <strong>“새 장소 문서”</strong> 버튼을 눌러 시작해보세요.
    </p>
  </div>
        ...
        <div class="space-y-3">
          ...
          <div>
            ...
            <input
              ...
              placeholder="예: 길을 잃은 자의 속마음을 들려주는 숲."
            />
          </div>
        </div>
        ...
        <div class="flex-1 flex flex-col gap-2">
          ...
          <div class="relative flex-1">
            <textarea
              ...
              placeholder="지형, 기후, 위험 요소, 관련 사건/인물 등을 적어보세요."
            ></textarea>
    ...
    <div class="flex flex-col items-end gap-1 pt-2 border-t border-slate-100 dark:border-slate-800">
      ...
      {:else}
        <div class="m-auto text-center text-sm text-slate-500 dark:text-slate-400 space-y-2">
          <p>왼쪽에서 장소 문서를 선택하거나,</p>
          <p>
            우측 상단의 <strong>“새 장소 문서”</strong> 버튼을 눌러 첫 문서를 만들어보세요.
          </p>
        </div>
      {/if}
    </section>
